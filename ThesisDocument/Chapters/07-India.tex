...
\begin{figure}[!htpb]
    \centering
    \includegraphics[width=0.85\linewidth]{Figures/fig_7_2.png}
    \caption[Neuromorphic Ecosystem Growth Projection]{Projected market sizes for neuromorphic computing (2026--2035). Blue line: global neuromorphic market (exponential growth from \$2.5B to \$32.5B). Orange line: India opportunity including domestic demand and export. Green line: India's manufacturing capacity. The growing gap between opportunity and capacity represents a multi-billion-dollar incentive for India to develop manufacturing leadership.}
    \label{fig:neuromorphic-projection}
\end{figure}
