...
\principle{The warehouse problem is not abstract. It drives every design choice in this chapter. Real latency, real power budgets, real optimization hardness.}
...
\design{Coalition MRTA is bipartite matching with subset constraints. It is NP-hard. But we can encode it as a graph problem.}
...
\insight{This transformation is not just mathematical convenience. It reveals the true structure of the problem: finding a maximum-weight subset with no internal conflicts.}
...
\design{QUBO is the intermediate form. Every constraint becomes a penalty term. The penalty magnitude must balance feasibility and optimality.}
...
\principle{The Ising mapping is bijective. Once your problem is in Ising form, the problem is solved by physics. Not simulation—actual physics.}
