...
\begin{titlepage}
    ...
    % BITS Pilani Logo (collaborating institution)
    \vspace{15pt}
    {\noindent\fontsize{9}{11}\selectfont\textbf{In collaboration with:}}
    \vspace{8pt}
    \begin{figure}
        \centering
        \includegraphics[width=0.18\linewidth]{bits-logo.pdf}
    \end{figure}
    \vspace{8pt}
